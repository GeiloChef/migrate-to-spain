<template>
  <div id="glutenfreies-essen">
    ...
    <div class="space-y-8 text-gray-700 leading-relaxed">
      ...
      <!-- Conclusion Box -->
      <div class="bg-gradient-to-r from-green-100 to-blue-100 rounded-2xl border border-green-300 p-6 shadow-lg relative overflow-hidden">
        <!-- Background icon -->
        ...
        <div class="relative z-10">
          <h3 class="!text-lg font-bold text-gray-900 text-lg mb-4">{{ $t('first-research-feasibility.sections.glutenFree.conclusion.title') }}</h3>
