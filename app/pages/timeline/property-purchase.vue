<template>
  <TimelineLayout 
    :previous-step="'/timeline/bureaucracy-prerequisites'"
    :previous-step-name="$t('story.timeline.step7.title')"
    :next-step="'/timeline/gestoria'"
    :next-step-name="$t('gestoria.title')"
  >
    <!-- Hero Section -->
